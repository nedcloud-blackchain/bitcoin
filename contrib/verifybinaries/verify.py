...
"""Script for verifying Blackcoin Core release binaries
...
WORKINGDIR = "/tmp/blackcoin_verify_binaries"
HASHFILE = "hashes.tmp"
HOST1 = "https://bitcoincore.org"
HOST2 = "https://bitcoin.org"
VERSIONPREFIX = "blackcoin-core-"
...
def main(args):
    ...
    if retval != 0:
        if retval == 1:
            ...
            print("gpg error. Do you have the Blackcoin Core binary release "
