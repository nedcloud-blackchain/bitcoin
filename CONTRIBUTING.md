Contributing to Blackcoin Core
============================

The Blackcoin Core project operates an open contributor model where anyone is
welcome to contribute towards development in the form of peer review, testing
and patches. This document explains the practical process and guidelines for
contributing.

First, in terms of structure, there is no particular concept of "Blackcoin Core
...
Before you start contributing, familiarize yourself with the Blackcoin Core build
system and tests. Refer to the documentation in the repository on how to build
Blackcoin Core and how to run the unit tests, functional tests, and fuzz tests.
...
[Blackcoin Core PR Review Club](https://bitcoincore.reviews/) meeting.
...
Most communication about Blackcoin Core development happens on IRC, in the
...
the pull request affects. Valid areas as:
  ...
  - `qt` or `gui` for changes to blackcoin-qt
...
fork of Blackcoin Core copies the merge. Instead, make any username mentions in a
...
The following applies to code changes to the Blackcoin Core project (and related
projects such as libsecp256k1), and is not to be confused with overall Bitcoin
Network Protocol consensus changes.

Whether a pull request is merged into Blackcoin Core rests with the project merge
