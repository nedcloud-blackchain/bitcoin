...
Multiple tools can list the available tracepoints in a `blackcoind` binary with
USDT support.
...
stap net        inbound_message  0x000000000014419e /src/blackcoind
stap net        outbound_message 0x0000000000107c05 /src/blackcoind
stap validation block_connected  0x00000000002fb10c /src/blackcoind
…
```
...
```
$ readelf -n ./src/blackcoind | grep NT_STAPSDT -A 4 -B 2
