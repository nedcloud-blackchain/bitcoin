...
const std::string CURRENCY_UNIT = "BLK"; // One formatted unit
...
enum class FeeEstimateMode {
    ...
    BLK_KVB,      //!< Use BLK/kvB fee rate unit
...
public:
    ...
    std::string ToString(const FeeEstimateMode& fee_estimate_mode = FeeEstimateMode::BLK_KVB) const;
