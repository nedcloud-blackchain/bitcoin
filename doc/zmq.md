...
The Blackcoin Core daemon can be configured to act as a trusted "border
router", implementing the blackcoin wire protocol and relay, making
...
The ZeroMQ feature in Blackcoin Core requires the ZeroMQ API >= 4.0.0
...
during the *configure* step of building blackcoind:
...
For instance:
    ...
    $ blackcoind -zmqpubhashtx=tcp://127.0.0.1:28332 \
...
From the perspective of blackcoind, the ZeroMQ socket is write-only; PUB
sockets don't even have a read function. Thus, there is no state
introduced into blackcoind directly. Furthermore, no information is
