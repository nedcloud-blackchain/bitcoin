...
Assumeutxo is a feature that allows fast bootstrapping of a validating blackcoind
...
considered active. This is the "traditional" mode of operation for blackcoind.
...
**Failure consideration:** if blackcoind unexpectedly halts after `m_stop_use` is set on
...
### Blackcoind restarts sometime after snapshot validation has completed

When blackcoind initializes again, what began as the snapshot chainstate is now
