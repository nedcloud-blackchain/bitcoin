...
"""Example logging Blackcoin Core utxo set cache flushes utilizing
    the utxocache:flush tracepoint."""

# USAGE:  ./contrib/tracing/log_utxocache_flush.py path/to/blackcoind
...
def main(blackcoind_path):
    ...
    b = BPF(text=program, usdt_contexts=[blackcoind_with_usdts])
