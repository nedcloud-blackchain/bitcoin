...
#define QAPP_APP_NAME_DEFAULT "Blackcoin-Qt"
#define QAPP_APP_NAME_TESTNET "Blackcoin-Qt-testnet"
#define QAPP_APP_NAME_SIGNET "Blackcoin-Qt-signet"
#define QAPP_APP_NAME_REGTEST "Blackcoin-Qt-regtest"
