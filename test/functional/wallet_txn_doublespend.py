...
class TxnMallTest(BitcoinTestFramework):
    ...
    def run_test(self):
        # All nodes should start with 1,250 BLK:
        ...
        # First: use raw transaction API to send 1240 BLK to node1_address,
        # but don't broadcast:
        ...
        # Create two spends using 1 50 BLK coin each
        ...
        # Node0's balance should be starting balance, plus 50BLK for another
        ...
        # Node0's total balance should be starting balance, plus 100BLK for
