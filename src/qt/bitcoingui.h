...
public:
    ...
    */
    ...
    /** Set the wallet model.
        The wallet model represents a blackcoin wallet, and offers access to the list of transactions, address book and sending
        functionality.
    */
...
public Q_SLOTS:
    ...
    /** Load Partially Signed Blackcoin Transaction from file or clipboard */
